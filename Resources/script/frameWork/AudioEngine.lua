...
function M.playMusic(filename, isLoop)
	...
	if UserData.musicOn ~= nil and  UserData.musicOn == true then
...
function M.playEffect(filename, isLoop)
	...
	if UserData.effectOn ~= nil and  UserData.effectOn == true then
		sharedEngine:playEffect(filename, loopValue)
	end
end
